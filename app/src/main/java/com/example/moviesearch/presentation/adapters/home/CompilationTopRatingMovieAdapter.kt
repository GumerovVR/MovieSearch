...
import com.example.moviesearch.presentation.adapters.movieslist.MovieDiffCallback

class CompilationTopRatingMovieAdapter(private val onClick: (Movie) -> Unit) :
